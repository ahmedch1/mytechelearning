...
class eCademy_Feedback_Slider3 extends Widget_Base {

	public function get_name() {
        return 'FeedbackSlider3';
    }
    ...
    $this->start_controls_section(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .feedback-area' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-coaching-feedback-box p' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .single-coaching-feedback-box p',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-coaching-feedback-box .client-info .title h3' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Core\Schemes\Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .single-coaching-feedback-box .client-info .title h3',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-coaching-feedback-box .client-info .title span' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Core\Schemes\Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .single-coaching-feedback-box .client-info .title span',
            ]
        );
	...
	protected function render() {
        ...
        endforeach;
        ?>
        <div class="feedback-area bg-f9f9f9">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-8 col-md-12">
                        <?php if( $count == 1 ): ?>
                            <div class="col-lg-12">
                        <?php else: ?>
                            <div class="coaching-feedback-slides owl-carousel owl-theme">
                        <?php endif; ?>
...
Plugin::instance()->widgets_manager->register( new eCademy_Feedback_Slider3 );