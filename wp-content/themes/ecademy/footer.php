...
?>
    ...
    if ( strpos($actual_link, 'themes.envytheme.com/ecademy') != false ): ?>
		<div class="et-demo-options-toolbar">
			...
			<?php endif; ?>
			<?php if( $home_url != 'https://themes.envytheme.com/ecademy-ld' ): ?>
				<a href="<?php echo esc_url( 'https://themes.envytheme.com/ecademy-ld/' ); ?>" class="hint--bounce hint--left hint--black" id="toggle-quick-options" aria-label="LearnDash Demo">
					<i class='bx bxs-book-reader'></i>
				</a>
			<?php endif; ?>
			<?php if( $home_url != 'https://themes.envytheme.com/ecademy-community' ): ?>
				<a href="<?php echo esc_url( 'https://themes.envytheme.com/ecademy-community/' ); ?>" class="hint--bounce hint--left hint--black" id="toggle-quick-options" aria-label="BuddyPress Demo">
					<i class='bx bx-group'></i>
				</a>
			<?php endif; ?>
			<?php if( $home_url != 'https://themes.envytheme.com/ecademy-tutor' ): ?>
