...
class eCademy_Tutor_Instructors extends Widget_Base {

	public function get_name() {
        return 'eCademy_Tutor_Instructors';
    }

	public function get_title() {
        return __( 'Tutor Instructors', 'ecademy-toolkit' );
    }
...
Plugin::instance()->widgets_manager->register( new eCademy_Tutor_Instructors );