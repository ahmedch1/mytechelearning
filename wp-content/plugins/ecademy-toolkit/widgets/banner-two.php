...
class eCademy_Banner_Two extends Widget_Base {

	public function get_name() {
        return 'eCademy_Banner_Two';
    }

	public function get_title() {
        return esc_html__( 'Banner Two', 'ecademy-toolkit' );
    }
        ...
        $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> __('Project Management Certification Training', 'ecademy-toolkit'),
				]
			);
        ...
        $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .banner-content h1, .banner-content h2, .banner-content h3, .banner-content h4, .banner-content h5, .banner-content h6' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .banner-content h1, .banner-content h2, .banner-content h3, .banner-content h4, .banner-content h5, .banner-content h6',
                ]
            );
	...
	protected function render() {
        ...
        <div class="banner-section" style="background-image:url(<?php echo esc_url( $settings['bg_image']['url'] ); ?>);">
...
Plugin::instance()->widgets_manager->register( new eCademy_Banner_Two );